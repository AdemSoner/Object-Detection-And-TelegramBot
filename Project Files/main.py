...
def SendTelegramMessage(object_name, status):
    ...
    if(status == 0):
        ...
        x = requests.post(url = "https://api.telegram.org/bot5217908223:AAGVbJMvMHbk-9rfcw7NRJalPFYRyw/sendMessage", data = {"chat_id":"8404204", "text":mesaj})
        #yukarıdaki link benim bota mesaj atmaktadır. Kendi botunuzu oluşturup uygun chatid ve bot url sini buraya koymanız gerekmektedir.
        print(x.text)
